    ...
    <div>
      ...
      <div className="jumbotron jumbotron-fluid bg-light text-dark">
        <div className="container text-center">
          ...
          <button className="start-button bg-dark text-light">
            GET STARTED TODAY
          </button>
        </div>
      </div>
      ...
      <HomeContainer className="container-fluid mb-5 slider-container">
        ...
        <section className="customer-logos pl-5 pr-5 row text-center">
          ...
          <div className="slide col-md-3">
            ...
            <button className="button-centered fitness-button">SHOULDER</button>
          </div>
          <div className="slide col-md-3">
      ...
      <div className="container-fluid mb-4">
        ...
        <div className="row pl-5 pr-5 text-center recipe-section">
          ...
          <div className="col-md-3">
            <img
              className="img-fluid"
              src="https://www.bbcgoodfood.com/sites/default/files/recipe-collections/collection-image/2013/05/epic-summer-salad.jpg"
            />
